...
class PumpsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create pump" do
    assert_difference('Pump.count') do
      post pumps_url, params: { pump: { company_id: @pump.company_id, identification: @pump.identification, name: @pump.name } }
    end
  ...
  test "should update pump" do
    patch pump_url(@pump), params: { pump: { company_id: @pump.company_id, identification: @pump.identification, name: @pump.name } }
